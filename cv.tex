...
% Colors
% \definecolor{color_highlight}{RGB}{70,130,180} % steelblue
\definecolor{color_highlight}{RGB}{30,144,255} % dodgerblue 1
\definecolor{color_barbg}{rgb}{0.8,0.8,0.8}

% Skills bar
\newcommand\skills[1]{
  \begin{tikzpicture}
    \fill[color_barbg,rounded corners=2.5] (0,0) rectangle (1,0.2);
    \fill[color_highlight,rounded corners=2.5] (0,0) rectangle ({#1},0.2);
  \end{tikzpicture}
}
...
\usepackage[colorlinks = true,
            linkcolor = color_highlight,
            urlcolor  = color_highlight,
            citecolor = color_highlight,
...
\section*{Select honors \& awards}
  \begin{tabular}{ p{2.5cm} p{15cm} } 
    ...
    2016 & NIH NIGMS MSTP Training Grant (GM008719) \\
